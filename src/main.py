...
def main_worker(local_rank, cfg):
    ...
    # all_parameters = list(model.parameters()) + list(model.loss_fn.parameters())
    # all_parameters = list(model.parameters())

    optimizer = torch.optim.Adam(model.parameters(), lr=cfg.optimizer.lr)
    # optimizer = torch.optim.Adam(all_parameters, lr=cfg.optimizer.lr)
    ...
    if cfg.load_checkpoint:
        file_path = Path(f"{cfg.path.ckp_dir}/{cfg.model.model_name}_MINDsmall_{cfg.load_mark}.pth")
